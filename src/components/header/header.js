        ...
        <div>
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-primary">
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                        <img src="https://mastermovers.ae/wp-content/uploads/2021/02/WhatsApp-Image-2021-02-27-at-9.59.39-AM.jpeg" className="mr-3 h-8 sm:h-9" alt="moving shifting" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Master Movers</span>
