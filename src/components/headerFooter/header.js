...
function Header() {
    ...
    return (
        ...
        <>
            ...
            <nav className="sticky top-0  bg-white  dark:bg-gray-900 shadow-sm h-16 ">
                <div className='container mx-auto flex flex-row px-2 sm:px-4 py-2.5 justify-between items-center'>
                    ...
                    <div className={mobileMenu ? 'block  z-50 fixed bg-white drop-shadow-2xl inset-y-0 w-11/12 p-6' : ' hidden '}>
                        ...
                        <ul className=' mt-8 space-y-1'>
                            ...
                            <li className='hover:text-orenge shadow-sm p-4 hover:bg-sky-200 rounded-md '><NavLink to='/about' onClick={() => setMobilemenu(false)}>About us</NavLink></li>
                            <li className='hover:text-orenge shadow-sm p-4 hover:bg-sky-200 rounded-md '><NavLink to='/reviews' onClick={() => setMobilemenu(false)}>Reviews</NavLink></li>
                            <li className='hover:text-orenge shadow-sm p-4 hover:bg-sky-200 rounded-md '><NavLink to='/relocation' onClick={() => setMobilemenu(false)}>Relocations</NavLink></li>
                            <li className='hover:text-orenge shadow-sm p-4 hover:bg-sky-200 rounded-md '><NavLink to='/contact' onClick={() => setMobilemenu(false)}>Contact us</NavLink></li>
                        </ul>
                    </div>
