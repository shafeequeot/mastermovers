  ...
  return (
    <div class=" inset-0  text-gray-700 md:flex-col flex flex-col m-4 space-y-3 items-center justify-center  transition-all ease-in-out duration-1000 transform translate-x-0 ">
        ...
        <div className='flex flex-row space-x-4 w-full '>
            <div className='w-1/3 p-3 bg-blend-multiply rounded-md space-y-3 bg-[url(https://blog.hubspot.com/hubfs/how-to-start-a-business.jpeg)] bg-blue-900 hover:bg-orange-400 hover:scale-110 ease-in-out duration-500 hover:cursor-pointer transform flex flex-col items-center'>
            ...
            <div className='w-1/3 p-3 bg-blend-multiply space-y-3 rounded-md bg-blue-900 bg-[url(https://blog.hubspot.com/hubfs/how-to-start-a-business.jpeg)] hover:bg-orange-400 hover:scale-110 ease-in-out duration-500 hover:cursor-pointer transform flex flex-col items-center'>
            ...
            <div className='w-1/3 p-3 bg-blend-multiply space-y-3 rounded-md bg-[url(https://blog.hubspot.com/hubfs/how-to-start-a-business.jpeg)] bg-blue-900 hover:bg-orange-400 hover:scale-110 ease-in-out duration-500 hover:cursor-pointer transform flex flex-col items-center'>
